...
urlpatterns = [
    ...
    path('post_forum', views.post_forum, name='instructor_post_forum'),
     ...
     # devoirs #
    #path('assignment_add', views.assignment_add, name='instructor-assignment-add'),
    # path('assignment_edit/<id>', views.assignment_edit, name='instructor-assignment-edit'),
    # path('assignments', views.assignments, name='instructor-assignments'),
